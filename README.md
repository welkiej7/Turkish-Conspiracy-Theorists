...
Our first network is visualized below is the all connections with a higher diameter than 5. We can point out that big network includes all of the conspiracy theory spreaders.
...
Nonetheless, we have found out that the impacts of tweets related to the keywords varies, and conspiracy theories are not the most central agents in our network.
